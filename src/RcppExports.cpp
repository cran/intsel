...
// l_ld
Rcpp::NumericVector l_ld(Rcpp::NumericVector& beta, Rcpp::NumericMatrix& x, Rcpp::NumericVector& y);
RcppExport SEXP _intsel_l_ld(SEXP betaSEXP, SEXP xSEXP, SEXP ySEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(l_ld(beta, x, y));
    return rcpp_result_gen;
END_RCPP
}
// intsel_cpp
Rcpp::List intsel_cpp(Rcpp::NumericMatrix& x, Rcpp::NumericVector& y, std::string& regul, Rcpp::NumericVector& lam, Rcpp::IntegerMatrix& grp, Rcpp::IntegerMatrix& grpV, Rcpp::IntegerVector& own_var, Rcpp::IntegerVector& N_own_var, Rcpp::NumericVector& etaG, Rcpp::NumericVector& init, double& init_stepsize, double& ls_shrink, double& partol, int& maxit, bool& verbose);
RcppExport SEXP _intsel_intsel_cpp(SEXP xSEXP, SEXP ySEXP, SEXP regulSEXP, SEXP lamSEXP, SEXP grpSEXP, SEXP grpVSEXP, SEXP own_varSEXP, SEXP N_own_varSEXP, SEXP etaGSEXP, SEXP initSEXP, SEXP init_stepsizeSEXP, SEXP ls_shrinkSEXP, SEXP partolSEXP, SEXP maxitSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix& >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(intsel_cpp(x, y, regul, lam, grp, grpV, own_var, N_own_var, etaG, init, init_stepsize, ls_shrink, partol, maxit, verbose));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_intsel_l_ld", (DL_FUNC) &_intsel_l_ld, 3},
    {"_intsel_intsel_cpp", (DL_FUNC) &_intsel_intsel_cpp, 15},
    {NULL, NULL, 0}
};
